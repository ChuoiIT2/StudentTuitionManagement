...
public class StudentView extends JFrame {
	...
	public StudentView() {
		...
		panel.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null),
				"Th\u00F4ng Tin Sinh Vi\u00EAn", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		showListSV.setModel(new DefaultTableModel(new Object[][] { { null, null, null, null, null, null, null, null },
				...
				new String[] { "STT", "H\u1ECD V\u00E0 T\u00EAn", "MSSV", "Nguy\u1EC5n Ng\u00E0nh",
						"H\u00ECnh Th\u1EE9c H\u1ECDc", "S\u1ED1 TC", "S\u1ED1 HP", "H\u1ECDc Ph\u00ED (VN\u0110)" }) {
			Class[] columnTypes = new Class[] { Integer.class, String.class, Integer.class, String.class, String.class,
		...
		comboBox.setModel(
				new DefaultComboBoxModel(new String[] { "Tất Cả Hình Thức", "SV Theo TC", "SV Theo CT Mẫu" }));
